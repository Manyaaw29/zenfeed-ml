...
# ============================================================================
try:
    stats_response  = api_get(f"{API_URL}/stats",   wake_msg="Waking up the server — first visit takes ~30 s…")
    history_response = api_get(f"{API_URL}/history", wake_msg="Loading community data…")
